                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            <div class="wt-post-media wt-img-effect zoom-slow">
                                                <a href="{{ route('plastik.blog.detay', ['slug'=> $item->slug]) }}"><img src="{{ asset($item->image) }}"></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            <div class="wt-post-info">
                                                ...
                                                <div class="wt-post-title ">
                                                    <h4 class="post-title"><a href="{{ route('plastik.blog.detay', ['slug'=> $item->slug]) }}">{{ $item->title }}</a></h4>
                                                </div>
                                                <div class="wt-post-text ">
                                                    <p>{!! Str::limit($item->content, 300) !!}</p>
                                                </div>
                                                <div class="wt-post-readmore ">
                                                    <a href="{{ route('plastik.blog.detay', ['slug'=> $item->slug]) }}" class="site-button-link black">{{ __('Tümünü Gör') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

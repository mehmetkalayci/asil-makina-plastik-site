                ...
                <div class="half-section">
                                        ...
                                        <div class="hover-box-content">
                                            <div class="wt-icon-box-wraper center site-bg-white">
                                                <div class="icon-content">
                                                    ...
                                                    <p>{{ $item->code }}</p>
                                                    <a href="{{ route('makina.urunler.detay', ['slug' => $item->slug]) }}"
                    ...
                    <div class="row">
                        <div class="col-12 d-flex  justify-content-end">
                            <a href="{{ route('makina.urunler') }}" class="site-button-link black">
                                Tüm Ürünler
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-12 m-b30">
                            <div class="about-section-three-right">
                                ...
                                <div class="ab-three-info">
                                    ...
                                    <a href="{{ route('makina.hakkimizda') }}"
            ...
            <div class="section-content">
                <div class="row justify-content-center d-flex align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 m-b30">
                        ...
                        <!-- TITLE END-->
                        <div class="p-t30">
                            <a href="{{ route('makina.hakkimizda') }}" class="site-button sb-bdr-dark">{{ __('Tümünü Gör') }}</a>
                        </div>
                    </div>

...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>404 - Asil Geri Dönüşüm Plastik Makina Sanayi ve Tic. Ltd. Şti.</title>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="page-notfound-content">
                                    ...
                                    <strong>404</strong>
                                    <p>{{ __('Aradığınız sayfa kaldırılmış, adı değiştirilmiş veya geçici olarak kullanılamıyor olabilir.') }}</p>

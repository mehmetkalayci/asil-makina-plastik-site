...
<div class="page-wraper" @if (app()->getLocale() === 'ar') style="direction: rtl;" @endif>
    ...
    <header class="site-header header-style-4 mobile-sider-drawer-menu">
                ...
                <div class="wt-topbar-outer d-flex justify-content-between">
                    ...
                    <div class="wt-topbar-right d-flex flex-wrap align-content-center">
                        <div class="wt-topbar-right-info">
                            <ul class="social-icons">
                                <li><a target="_blank" rel="nofollow" href="{{ $facebook }}"
                                       class="fa fa-facebook-square"></a></li>
                                <li><a target="_blank" rel="nofollow" href="{{ $twitter }}"
                                       class="fa fa-twitter-square"></a></li>
                                <li><a target="_blank" rel="nofollow" href="{{ $linkedin }}"
                    ...
                    <div class="wt-topbar-left d-flex flex-wrap align-content-start">
                        <ul class="wt-topbar-left-info">
                            ...
                            <li><i class="fa fa-envelope-square"></i><span>{{ __('Eposta') }} : </span>{{ $email1 }}
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="nav-animation header-nav navbar-collapse collapse d-flex justify-content-center">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="{{ route('makina.anasayfa') }}">{{ __('Anasayfa') }}</a></li>
                            <li><a href="{{ route('makina.hakkimizda') }}">{{ __('Hakkımızda') }}</a></li>
                            <li><a href="{{ route('makina.urunler') }}">{{ __('Ürünler') }}</a></li>
                            <li><a href="{{ route('makina.blog') }}">{{ __('Blog') }}</a></li>
                            <li><a href="{{ route('makina.iletisim') }}">{{ __('İletişim') }}</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="extra-cell two">
                            <div class="header-search">
                                <a href="{{route('plastik.anasayfa')}}"
                                   class="header-search-icon">{{ __('Geri Dönüşüm') }} <i
                                        class="fa fa-recycle slide-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-menu bg-cover bg-no-repeat"
             style="background-image: url({{ asset('images/background/bg11.jpg') }});">
            <button type="button" class="full-menu-close"></button>
            <div class="vertical-content-wrap">
                <div class="vertical-centered">
                    <!-- MAIN Vav -->
                    <div class="contact-form-outer">
                        <form class="cons-contact-form1" method="post" action="{{ route('makina.iletisim.gonder') }}">
                            @csrf
                            <!-- TITLE START-->
                        ...
                        <div class="widget widget_newsletter">
                            ...
                            <div class="newsletter-bx">
                                <div class="input-group">
                                    <input name="news-letter" id="news-letter" class="form-control"
                                           placeholder="{{ __('Eposta girin') }}" type="text">
                                    <span class="input-group-btn">
                                            <button id="news-letter-btn" type="button" class="site-button"
                                                    data-toggle="modal" data-target="#subscribeModal"><i
                                ...
                                <div class="wt-icon-box-wraper left">
                                    <div class="wt-icon-box-sm">
                                        <span class="icon-cell site-text-primary"><i
                                                class="flaticon-location"></i></span>
                                    </div>
                                    <div class="icon-content">
            ...
            <div class="container">
                <div class="footer-bottom-info">
                    <div class="footer-copy-right">
                        <span class="copyrights-text">Copyright © <?php echo date('Y') ?> <span
                                class="site-text-primary">Asil Makina Plastik</span> | All rights reserved </span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form class="cons-contact-form" method="POST" action="{{ route('subscribe') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" required class="form-control" id="modal-eposta" name="modal-eposta"
                               placeholder="{{ __('Eposta') }}" value="{{ old('modal-eposta') }}">
                        @error('modal-eposta')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
